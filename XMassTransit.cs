...
namespace MassTransit.WindowsService
{
    public static class XMassTransit
    {
        ...
        private static string UriScheduler => "queue:" + SchedulerQueueName;
        private const bool UseTransactionalBus = true;
        ...
        private static void AddMassTransitServicesFrom(this IServiceCollection services
            ...
            , params Assembly[] assemblies)
        {
            services.AddMassTransit(busConfigurator =>
            {
                ...
                //By default, sagas are in-memory, but this should be changed to a durable saga repository.
        ...
        private static readonly bool WaitUntilHostIsStarted = true;
        ...
        private static IHostBuilder CreateDefaultBuilder(this string[] args) => Host.CreateDefaultBuilder(args);
        ...
        /// </example>
        private static IHostBuilder CreateMassTransitHostBuilder(this string[] args
        ...
        private static IHostBuilder CreateMassTransitHostBuilder
        ...
        /// <param name="assemblies">List of Assemblies to register Consumers</param>
        public static async Task<Microsoft.Extensions.Hosting.IHost> StartMassTransitHost(this string[] args
            , Action<HostBuilderContext, IServiceCollection>? configureServices = null
            , Action<IRabbitMqBusFactoryConfigurator, HostBuilderContext>? configureRabbitMq = null
            , Action<IServiceCollectionBusConfigurator, HostBuilderContext>? configureBus = null
        ...
        {
            var hostBuilder =
                args.CreateMassTransitHostBuilder(configureBus, configureRabbitMq, configureServices, assemblies);
        ...
        private static void ConfigureRabbitMq(this IRabbitMqBusFactoryConfigurator rabbitConfigurator
